...
#define RING_BUFFER_MASK(rb) (rb->buffer_mask)
  ...
  inline void ring_buffer_safe_queue_arr(ring_buffer_t *buffer, const char *data, ring_buffer_size_t size)
  {
    if ( ring_buffer_num_items(buffer) + size <= buffer->buffer_mask)
